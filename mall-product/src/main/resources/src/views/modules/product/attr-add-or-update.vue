<template>
  <el-dialog
    ...
    <el-form-item label="0:只允许单个值，1:允许多个值" prop="valueType">
      <el-input v-model="dataForm.valueType" placeholder="0:只允许单个值，1:允许多个值"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          valueType: [
            { required: true, message: '0:只允许单个值，1:允许多个值不能为空', trigger: 'blur' }
          ],
          attrType: [
